...
describe('Irish Time Phrase', () => {
  describe('with specific dates', () => {
    const testCases: TestCase[] = [
      ...
      { input: '2025-05-21T01:00:00', expected: 'Tá sé a haon a chlog' },
      { input: '2025-05-21T02:00:00', expected: 'Tá sé a dó a chlog' },
      { input: '2025-05-21T03:00:00', expected: 'Tá sé a trí a chlog' },
      { input: '2025-05-21T04:00:00', expected: 'Tá sé a ceathair a chlog' },
      { input: '2025-05-21T05:00:00', expected: 'Tá sé a cúig a chlog' },
      { input: '2025-05-21T06:00:00', expected: 'Tá sé a sé a chlog' },
      { input: '2025-05-21T07:00:00', expected: 'Tá sé a seacht a chlog' },
      { input: '2025-05-21T08:00:00', expected: 'Tá sé a hocht a chlog' },
      { input: '2025-05-21T09:00:00', expected: 'Tá sé a naoi a chlog' },
      { input: '2025-05-21T10:00:00', expected: 'Tá sé a deich a chlog' },
      { input: '2025-05-21T11:00:00', expected: 'Tá sé a haon déag a chlog' },
